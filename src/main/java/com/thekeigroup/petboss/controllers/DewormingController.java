 ...
 * @author ICSGH-BILLY
 */
@Named(value = "dewormingController")
@SessionScoped
public class DewormingController implements Serializable {
    ...
    public void saveTreatment(){
        ...
        try {
            if(null == selectedPet){
                Msg.genericError("Please select Pet to deworm");
                return;
            }
    ...
    {
//        treatmentsList = commonService.petTreatmentHistoryByDiagnosis(selectedPet, DiagnosisCategory.DEWORMING);
