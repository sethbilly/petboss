 ...
 * @author ICSGH-BILLY
 */
@Named(value = "otherTreatmentController")
@SessionScoped
public class OtherTreatmentController implements Serializable
{
    ...
    public void saveTreatment()
    {
        ...
        try
        {
            if (null == selectedPet)
            {
                Msg.genericError("Please select Pet");
                return;
            }
    ...
    {
//        treatmentsList = commonService.petTreatmentHistoryByDiagnosis(selectedPet, DiagnosisCategory.GENERAL_TREATMENTS);
